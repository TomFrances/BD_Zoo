...
create table LesAnimaux (
	...
	constraint LesAnimaux_C3 check (anNais >= 2000)
);
...
insert into LesEmployes values ('Martins'  ,       'Sartene' );
insert into LesEmployes values ('Caffiau' ,    'Calvi' );
...
insert into LesSpecialites values ('Martins'  ,       'fauve' );
insert into LesSpecialites values ('Caffiau' ,    'fauve' );
...
insert into LesGardiens values (12      ,       'Martins' );
insert into LesGardiens values (12      ,       'Caffiau' );
insert into LesGardiens values (11      ,       'Martins' );
insert into LesGardiens values (11      ,       'Caffiau' );
